...
class MemoryRank(Enum):
    field_1R_RDIMM = '1R RDIMM'
    field_2R_RDIMM = '2R RDIMM'
    field_4R_LRDIMM = '4R LRDIMM'
    other = 'other'
...
class Memory(BaseModel):
    ...
    eccEnabled: Optional[bool] = Field(
        None,
    ...
    hardwareEncryption: Optional[bool] = Field(
        None,
    ...
    memorySize: Optional[float] = Field(None, description='Memory size of RAM.')
    ...
    type: Optional[Type6] = Field(
        None, description='NGSI entity type. It has to be Memory'
    )
