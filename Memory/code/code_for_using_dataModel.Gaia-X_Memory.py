...
memorySize = {'type': 'Property', 'value': 16, 'unitCode': 'Gb'}
attribute = "memorySize"
value = memorySize
# The next line creates the query for inserting this attribute in a NGSI-LD context broker if the attribute does not exist it creates it
print(sdm.update_broker(dataModel, subject, attribute, value, serverUrl=serverUrl, updateThenCreate=True))

memoryClass = "{'type': 'Property', 'value': 'DDR SDRAM'}"
attribute = "memoryClass"
value = memoryClass
# The next line creates the query for inserting this attribute in a NGSI-LD context broker if the attribute does not exist it creates it
print(sdm.update_broker(dataModel, subject, attribute, value, serverUrl=serverUrl, updateThenCreate=True))

memoryRank = "{'type': 'Property', 'value': 'other'}"
attribute = "memoryRank"
value = memoryRank
# The next line creates the query for inserting this attribute in a NGSI-LD context broker if the attribute does not exist it creates it
print(sdm.update_broker(dataModel, subject, attribute, value, serverUrl=serverUrl, updateThenCreate=True))

eccEnabled = {'type': 'Property', 'value': False}
